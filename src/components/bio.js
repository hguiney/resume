          ...
          const contactMethods = Object.keys( this.props )
            .map( ( prop ) => {
              switch ( prop ) {
                ...
                case 'showPersonalTwitter':
                  return !!this.props.showPersonalTwitter && <a id="twitter" className="bio__attribute bio__attribute--twitter" href={ `https://twitter.com/${social.personalTwitter}` }>Twitter</a>
                case 'showImdb':
                ...
                case 'showYoutube':
                  return !!this.props.showYoutube && <a id="youtube" className="bio__attribute bio__attribute--youtube" href={ `https://www.youtube.com/c/${social.youtube}` }>YouTube</a>
                default:
